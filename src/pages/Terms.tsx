      ...
      sections: [
        {
          ...
          content: "Нам не нужны ваши данные. Мы не собираем никакой личной информации, кроме той, которая необходима для функционирования форума."
        },
        {
          title: "Безопасность данных",
          content: "Все данные шифруются и даже администратор не может получить доступ, поэтому если что-то случится, он не сможет восстановить. Мы используем современные методы шифрования для защиты вашей информации."
        },
        {
          title: "Владелец",
